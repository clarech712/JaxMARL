...
def plot_contributions(mech_idx, state_seq, mech, rival_mechs, gen, config):
    """Plots contributions
    ...
    # Part 3: Neighbour
    nidx = (mech_idx + 1) % config["population_size"]
...
@hydra.main(version_base=None, config_path="config", config_name="ippo_rnn_meta_vote")
def main(config):
